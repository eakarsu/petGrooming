...
const navigation = [
  ...
  { name: 'AI Drafts & Knowledge', href: '/assistant', icon: ClipboardList },
  { name: 'Groomer Setup', href: '/setup', icon: Settings },
  { name: 'Receipts & Refunds', href: '/receipts', icon: CreditCard },
